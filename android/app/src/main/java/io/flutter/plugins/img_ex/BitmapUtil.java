package io.flutter.plugins.img_ex;
...
public class BitmapUtil {
    ...
    public static Map<String, String> getImageLatitudeFromData(String uriStr, Context context, byte[] data) throws FileNotFoundException {
        String latitude = "";
        String longitude = "";
        ...
        try {
            ...
            Log.e("zhu", "gpsLatitude = " + gpsLatitude + " , latitudeRef = " + latitudeRef +
